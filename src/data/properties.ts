...
export const properties: Property[] = [
  ...
  },
  {
    ...
    rooms: [
      {
        name: 'Standard Room',
        description: 'Comfortable room with modern amenities, perfect for pilgrims and solo travelers.',
      ...
      {
        name: 'Deluxe Room',
        description: 'Spacious room with enhanced comfort and premium furnishings, ideal for extended stays.',
        bedType: 'King Bed',
        capacity: 2,
        price: '₹1,999',
      ...
      {
        name: 'Premium Room',
        description: 'Luxurious room with superior comfort and elegant interiors, perfect for families and groups.',
        bedType: 'King Bed',
        capacity: 3,
        price: '₹2,499',
    ...
    dining: [
      {
        ...
        image: '/budhar-saalt-bodhgaya-restaurent.jpg',
      },
    ],
    nearbyAttractions: [
      {
